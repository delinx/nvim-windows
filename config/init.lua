...
vim.o.guicursor = ""  -- Controls the appearance of the cursor in GUI mode. Empty string leaves it to default.
vim.o.guicursor = 'a:blinkon0'
vim.o.guifont = "Berkeley Mono:h19"  -- Sets the GUI font to RobotoNerd with height 14.
...
vim.o.clipboard = "unnamedplus"  -- Allows sharing clipboard with the system.
